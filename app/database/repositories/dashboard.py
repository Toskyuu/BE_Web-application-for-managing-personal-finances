...
class DashboardRepository:
    ...
    async def get_dashboard(
        ...
        budgets_response = await BudgetRepository.get_budgets_by_user(db, user_id=user_id, page=1, size=6, month_year=date.today(), sort_by="spent_to_limit_ratio", order="desc")
