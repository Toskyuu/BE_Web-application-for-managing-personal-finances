...
from app.api.schemas.Stats import SummaryResponse, TransactionsOverTimeResponse
...
class Dashboard(DashboardBase):
    ...
    incomes_expenses_summary: Optional[SummaryResponse] = None
    transactions: Optional[TransactionListResponse] = None
    budgets: Optional[BudgetListResponse] = None
    expenses: Optional[TransactionsOverTimeResponse] = None
